...
const candidates = [
    ...
    { id: 2, name: "Zahriah Queensha Nurambiyah", jurusan: "Matematika", visi: "Inovasi dalam sains", misi: "Workshop dan kompetisi rutin" },
    { id: 3, name: "Raisa Azizah", jurusan: "Ilmu Pengetahuan Alam", visi: "Eksplorasi ilmu pengetahuan", misi: "Eksperimen dan penelitian" },
    { id: 4, name: "Damara Aquene", jurusan: "Ilmu Pengetahuan Sosial", visi: "Pelestarian lingkungan", misi: "Kampanye dan edukasi" },
    { id: 5, name: "Tsar Serkan", jurusan: "Ilmu Pengetahuan Sosial", visi: "Teknologi masa depan", misi: "Coding bootcamp dan hackathon" },
    { id: 6, name: "Lina Kusuma", jurusan: "Ekonomi", visi: "Kemandirian finansial", misi: "Simulasi bisnis dan seminar" }
];
...
if (window.location.pathname.includes('admin.html')) {
    ...
    document.getElementById('resetBtn').addEventListener('click', function() {
        if (confirm('Yakin reset voting? Semua data akan hilang!')) {
            ...
            localStorage.removeItem('votedNIK');
            // Re-inisialisasi
            const initialVotes = {};
            candidates.forEach(c => initialVotes[c.id] = 0);
            saveToStorage('votes', initialVotes);
